...
DATABASES = {
    'default': {
        ...
        'NAME': 'webchat',                      # Or path to database file if using sqlite3.
        'USER': 'webchat',                      # Not used with sqlite3.
        'PASSWORD': 'webchat123',                  # Not used with sqlite3.
...
STATIC_ROOT = os.path.join(ROOT, 'static_collect').replace('\\', '/')
...
SECRET_KEY = 'o0nf6j0)b-w#k#ziy4smu*ac_#2ev8ml6t+wi$rk=48lck(qo!'
